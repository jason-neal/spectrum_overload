...
sys.path.append(
    os.path.join(os.path.abspath(os.path.dirname(__file__)), "..", "spectrum_overload")
)
...
latex_documents = [
    (
        master_doc,
        "spectrum_overload.tex",
        "spectrum_overload Documentation",
        author,
        "manual",
    )
]
...
man_pages = [
    (master_doc, "spectrum_overload", "spectrum_overload Documentation", [author], 1)
]
